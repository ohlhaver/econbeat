class StaticPagesController < ApplicationController
  ...
  def home
    if current_user
      ...
      @starred_actions = current_user.starred_author_action_feed.find_all{|i| i.created_at >= 6.hours.ago}.sort_by{|e| -e[:id]}
      ...
      if @author_actions.empty?
        flash.now[:notice] = "Get started by following any of the authors listed below!" unless flash[:notice]
